...
class JavaConstantLong(JavaConstant):
    def __init__(self, longHighBytes, longLowBytes):
        self.tag = constant_tags['TAG_CONSTANT_LONG']
        self.highBytes = longHighBytes
        self.lowBytes = longLowBytes
